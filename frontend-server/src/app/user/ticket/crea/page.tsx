...
import { Button, Autocomplete, Typography, Container, Grid } from "@mui/material";
    ...
    <>
      <Container>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={6}>
            <Autocomplete
              ...
              onChange={(_, value: { id: number; label: string } | null) => {
                value === null ? formik.setFieldValue("type_id", "") : formik.setFieldValue("type_id", value.id);
              }}
          ...
          <Grid item xs={12}>
            <TextField label="Titolo" name="label" type="text" formik={formik} />
          </Grid>
          <Grid item xs={12}>
            <TextField maxRows={4} label="Descrizione" name="description" type="text" formik={formik} />
          </Grid>
